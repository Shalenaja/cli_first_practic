<template>
    <div class="project-item">
        <img class="project-item__img" :src="item.img" alt="bedroom_img">
        ...
        <div class="project-item__info">
            <div class="project-item__info_left">
                <h2 class="project-item__info_title">{{item.title}}</h2>
                <div class="project-item__info_link">
                    <a href="#">{{item.link1}}</a>
                    <a href="#">{{item.link2}}</a>
                </div>
            </div>
            <button class="project-item__info_button">
