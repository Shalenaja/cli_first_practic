    ...
    <footer class="footer center">
            <nav class="footer__social">
                <div class="footer__social_logo">
                    <a href="IndexComponent.vue" class="logo_img">
                    ...
                    <a href="IndexComponent.vue" class="logo_name">Interno</a>
                </div>
            ...
            <nav class="footer__link-menu">
                ...
                <ul>
                    <li><a class="footer__link-menu_text" href="IndexComponent.vue">Home</a></li>
                    <li><a class="footer__link-menu_text" href="ProjectComponent.vue">Project</a></li>
                    <li><a class="footer__link-menu_text" href="BlogComponent.vue">Blog</a></li>
                </ul>
            </nav>
